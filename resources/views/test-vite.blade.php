...
@section("contenu")
    ...
    '../fonts/**',
        ...
        <p>Il faut aussi avoir modifié la variable d'environnement <code>FILESYSTEM_DISK</code> en lui donnant comme
            valeur
            :</p>
        ...
        <p><strong>Attention : </strong> il faut avoir mis à jour la variable d'environnement <code>APP_URL</code> et
            <code>ASSET_URL</code> sur la
            machine de déploiement.</p>
        <p>Dans notre cas <code>APP_URL=http://marathon.ipa.iutlens.local/~but24_groupeT</code> et
            <code>ASSET_URL=http://marathon.ipa.iutlens.local/~but24_groupeT</code>.</p>
        ...
        <ul>
            ...
            <li>
                <p>Utiliser à partir du composant <code>TestLayout</code> avec la vue <code>components/test-layout.blade.php</code>.
                </p>
            </li>
        </ul>
    </div>
